...
import com.example.user.zle.coverflow.CoverFlow;
import com.example.user.zle.coverflow.ReflectingImageAdapter;
import com.example.user.zle.coverflow.ResourceImageAdapter;
